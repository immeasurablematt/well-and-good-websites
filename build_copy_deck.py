...
sr = sub.add_run("Revised 2026-06-16 · reflects updated positioning (custom websites for small and medium businesses)")
sr.italic = True
...
body("Well and Good Websites offers three clear packages: $497, $997, and $1,497. The right fit depends on how much copy, photography, booking flow, review support, and launch help your business needs.")
...
body("Website builders can work if you have the time and confidence to write, design, structure, and launch the site yourself. Well and Good is for owners who want a custom site done quickly around their real business.")
...
h3("Clear pricing")
body("Packages are visible from the start, so you can decide what level of help makes sense.")
h3("Fast launch path")
