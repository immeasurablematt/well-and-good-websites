import {BridgeScene,Stage,LogoFinish,CrestOutline,BridgeMagic,DEFAULTS} from './BridgeMagic';
...
export const WORKBENCH={
 ...
 overlays:[{id:'bridge3d',label:'3D bridge mesh and camera',from:0,duration:TOTAL,component:BridgeScene},{id:'bridge',label:'Original logo finish',from:0,duration:TOTAL,component:LogoFinish,props:DEFAULTS,schema},{id:'outline',label:'Fixed crest outline',from:0,duration:TOTAL,component:CrestOutline}],
