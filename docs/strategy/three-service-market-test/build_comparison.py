...
ROWS = [
    dict(
        ...
        offer="Fixed-scope build or redesign, free preview only after qualification, optional care plan (CAD 100 to 150 per month, observed local range)",
        currency="CAD", upfront=(2500, 3500, 5000), monthly=(0, 100, 150), months_in_90d=2,
        direct_costs=(50, 50, 50), sales_h=(20, 15, 8), delivery_h=(40, 30, 22), monthly_h=(0, 1, 1),
    ...
    dict(
        ...
        currency="USD", upfront=(2500, 4000, 6000), monthly=(2500, 3500, 5000), months_in_90d=2,
        direct_costs=(100, 100, 100), sales_h=(40, 25, 12), delivery_h=(35, 30, 25), monthly_h=(28, 30, 35),
        price_basis="Deliberately below fractional leadership benchmarks (USD 209/hr, FRAK USD 5,000 to 8,000, which skew to leadership roles). Anchored nearer Ahrefs agency SEO retainer average USD 3,209 and Toronto SEO packages CAD 2,500 to 6,000. Content-specific rate evidence is thin",
        ...
        wtp_evidence="47% of B2B marketers outsource content creation (CMI, search summary); Canadian VC deal count at lowest since 2017 in Q1 2026 (CVCA via BetaKit)",
        time_to_first_cash="Project deposit (assumption: 2 to 6 weeks after a warm conversation)",
        recurring_obligation="High hours per client, so capacity caps it at 2 or 3 clients; concentration risk if one ends",
    ...
    dict(
        ...
        currency="USD", upfront=(2500, 4000, 6000), monthly=(2500, 3500, 5000), months_in_90d=2,
        direct_costs=(100, 100, 100), sales_h=(50, 30, 15), delivery_h=(35, 30, 25), monthly_h=(28, 30, 35),
        price_basis="Same as G3",
        proof="Strong for this buyer; no local presence needed",
        reachable_now="Unknown; same network, more remote",
        wtp_evidence="Early-stage VC-backed firms are 36% of fractional hiring (Fractional Jobs, US only); over 70% of Q2 2026 startup capital went to AI companies (Crunchbase)",
    ...
    dict(
        ...
        reachable_now="Small: 10.7% of AI-using 1 to 4 staff firms used outside help (StatCan); no measurable local search",
    ...
    dict(
        ...
        wtp_evidence="Medium: 30.2% of AI-using 100+ staff firms used outside help (StatCan); planned AI use rose from 14.5% to 25.2% in a year; Flowgrammer and BotLogix already sell to Niagara",
        time_to_first_cash="Diagnostic fee at signing",
