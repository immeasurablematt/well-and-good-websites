...
def founder():
    return '''<section class="founder-section container section" id="about"><div class="founder-photo"><img src="/assets/matt-headshot.webp" width="600" height="600" loading="lazy" alt="Matthew Baggetta."></div><div><h2>You work<br>directly with Matt.</h2><p>I’m Matthew Baggetta, based in Welland. Through Jetta Grove Consulting, I’ve worked on content and growth marketing for technology businesses.</p><p>Here, I bring that experience to your website, marketing, and everyday operations. We agree on the work, and you review it with me.</p>''' + cta() + '</div></section>'
...
home = '''<section class="business-hero"><div class="container"><h1>Running your business shouldn’t mean <em>doing everything yourself.</em></h1><p class="hero-description">Website design, SEO, content, and custom AI automation for businesses in Niagara and the GTA. Work directly with Matt, based in Welland, on the part your business needs.</p><div class="hero-actions">''' + cta() + '''<a class="text-link" href="#services">Explore services ↗</a></div></div></section>
...
websites = '''<section class="service-hero container"><p class="label">Website design · Niagara &amp; GTA</p><h1>Give people a clear<br>reason to choose you.</h1><div class="hero-lower"><div class="hero-copy"><p class="hero-description">Website strategy, copy, design, and development with Matt in Welland. Help customers understand your services, see your work, and get in touch.</p><div class="hero-actions">''' + cta() + '''<a class="text-link" href="#plans">Compare packages ↗</a></div></div><figure class="website-hero-art"><img src="/assets/frankbaggetta-20260908.webp" width="1440" height="1000" fetchpriority="high" alt="The website built for musician Frank Baggetta."></figure></div></section>
<section class="capabilities container section"><h2>A website built around<br>your customers’ next step.</h2><div class="capability-list"><article><h3>Explain the work</h3><p>Bring your services, work examples, and practical questions into a clear page structure. I write the copy and design the pages so visitors can decide whether your business is right for them.</p></article><article><h3>Make contact easy</h3><p>Give visitors a direct way to call, request a quote, or reach your booking system. We check the connections your site needs and agree on them before the build.</p></article><article><h3>Prepare for search</h3><p>Build readable service information, page titles, and a mobile layout into the site. Hosting and ongoing support follow the package or project scope we agree.</p></article></div></section>''' + pricing() + '''<section class="approach-section container section"><h2>See a direction<br>before you decide.</h2><ol class="process-list"><li><h3>Tell me about the business.</h3><p>Share your current website or social page and what customers should be able to do.</p></li><li><h3>Review a free preview.</h3><p>I prepare a private preview. You can judge the direction with no obligation to buy.</p></li><li><h3>Agree on the build.</h3><p>We confirm scope, price, and support. You review the work before publication.</p></li></ol></section>''' + project() + faq([
...
growth = '''<section class="service-hero container"><p class="label">SEO &amp; content · Niagara &amp; GTA</p><h1>Help the right people<br>find your business.</h1><div class="hero-lower growth-lower"><div class="hero-copy"><p class="hero-description">Local SEO, content, and visibility in Google, ChatGPT, and Claude for businesses in Niagara and the GTA. Built around what you sell and how customers search.</p><div class="hero-actions">''' + cta() + '''<a class="text-link" href="#plans">Compare packages ↗</a></div></div><div class="growth-art" aria-label="Search, content and enquiries"><span>Search.</span><span>Consider.</span><span>Get in touch.</span></div></div></section>
<section class="capabilities container section"><h2>Make your expertise<br>easier to find.</h2><div class="capability-list"><article><h3>Search and local visibility</h3><p>Check whether search engines can reach and index your pages. Improve service information, Google Business Profile, and business listings so customers can find what you do and where you work.</p></article><article><h3>Content worth finding</h3><p>Write service pages and useful answers around the questions customers ask before getting in touch. Use your experience and examples to explain the work, with a clear next step for the reader.</p></article><article><h3>AI search and measurement</h3><p>Check mentions and citations in ChatGPT and Claude. Review available search impressions, clicks, and enquiries to see what is being found and where more work is needed.</p></article></div></section>
<section class="approach-section container section"><h2>Start with what<br>needs attention.</h2><ol class="process-list"><li><h3>Review your current visibility.</h3><p>We look at your website, service area, and available search data. That helps us separate technical problems from gaps in the information customers need.</p></li><li><h3>Agree on the work.</h3><p>Choose a defined search or content project, or a package with ongoing support. We confirm the pages, content, access, and measures before paid work begins.</p></li><li><h3>Review what changes.</h3><p>Use the available search and enquiry data to assess the work. Rankings and AI citations can change; they are measures to watch, not promised outcomes.</p></li></ol></section>
<section class="case-story container section"><p class="label">Website &amp; local search · Frank Baggetta</p><h2>Service pages, music,<br>and a way to enquire.</h2><p>For Toronto musician Frank Baggetta, the rebuild brought five music services, performance videos, and event enquiries into one website. Frank reported three new enquiries in the first month after the original launch.</p><p><a class="text-link" href="/frank-baggetta/">Read Frank’s website case study ↗</a></p></section>''' + pricing() + founder() + faq([
...
pages = {
    ...
    'index.html': page('Websites, growth marketing and AI operations', 'Website design, SEO, content, and custom AI automation for Niagara and GTA businesses. Work directly with Matthew Baggetta in Welland, Ontario.', home),
    'services/websites/index.html': page('Website design in Niagara & the GTA', 'Website strategy, copy, design, and development with Matthew Baggetta in Welland. Compare packages or request a free private website preview.', websites,'websites'),
    'services/growth/index.html': page('Niagara SEO & content marketing', 'Local SEO, content, and visibility in Google, ChatGPT, and Claude for Niagara and GTA businesses. Work directly with Matthew Baggetta in Welland.', growth,'growth'),
...
def build():
    ...
    for name, html in pages.items():
        ...
        metadata = f'<link rel="canonical" href="{url}"><meta property="og:type" content="website"><meta property="og:site_name" content="Well and Good Growth"><meta property="og:title" content="{title}"><meta property="og:description" content="{description}"><meta property="og:url" content="{url}"><meta property="og:image" content="https://www.wellandgoodgrowth.ca/assets/wgw-logo-primary.png"><meta name="twitter:card" content="summary_large_image">'
    ...
    (OUTPUT / 'robots.txt').write_text('User-agent: *\nAllow: /\nSitemap: https://www.wellandgoodgrowth.ca/sitemap.xml\n')
